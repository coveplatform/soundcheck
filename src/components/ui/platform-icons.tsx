...
export function SoundCloudIcon({ className = "h-5 w-5" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
      <path d="M7 15.5c-2.5 0-4.5-2-4.5-4.5s2-4.5 4.5-4.5c.3 0 .6 0 .9.1C8.5 4.5 10.5 3 13 3c3 0 5.5 2.5 5.5 5.5 0 .4 0 .8-.1 1.1 1.5.5 2.6 2 2.6 3.7 0 2.2-1.8 4-4 4H7z"/>
    </svg>
  );
}
...
export function SpotifyIcon({ className = "h-5 w-5" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
