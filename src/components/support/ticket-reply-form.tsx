    ...
    <div className="space-y-3">
      ...
      <div className="space-y-2">
        ...
        <textarea
          ...
          className="w-full px-3 py-2 border-2 border-black text-sm min-h-[120px] resize-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-black focus-visible:ring-offset-2"
          maxLength={4000}
          disabled={isClosed}
        />
      </div>
