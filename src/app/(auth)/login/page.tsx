...
export default function LoginPage() {
  ...
  // Email/password is collapsed by default — most use Google.
  ...
  return (
    <div className={`${jakarta.className} w-full`}>
      <div className="mb-8">
        ...
        <p className={`${mono.className} mt-2 text-[13px] text-white/50`}>sign in to your account</p>
      </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex justify-end">
              <Link
                ...
                className={`${mono.className} text-[12px] text-white/45 hover:text-white transition-colors`}
              >
                forgot password?
              </Link>
            </div>
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="group w-full inline-flex items-center justify-center gap-2 bg-[#6ee7ff] text-black font-extrabold text-[15px] py-3.5 hover:bg-white transition-colors disabled:opacity-60"
            >
              {isLoading ? (
                <>
      ...
      <p className={`${mono.className} text-[13px] text-white/50 text-center mt-8`}>
        ...
        <Link href={signupUrl} className="font-bold hover:text-white transition-colors" style={{ color: ACCENT }}>
          sign up
        </Link>
      </p>
    </div>
