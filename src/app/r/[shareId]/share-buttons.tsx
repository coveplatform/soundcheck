  ...
  return (
    <div className="flex flex-wrap justify-center gap-3">
      ...
      <button
        ...
        className="inline-flex items-center gap-2 px-4 py-2.5 rounded-full text-sm font-medium bg-neutral-800 text-white hover:bg-neutral-700 transition-all"
      >
      ...
      <button
        ...
        className="inline-flex items-center gap-2 px-4 py-2.5 rounded-full text-sm font-medium bg-gradient-to-r from-purple-600 to-pink-600 text-white hover:from-purple-500 hover:to-pink-500 transition-all disabled:opacity-50"
      >
        {downloading ? (
          <>
