...
export const metadata: Metadata = {
  // MixReflect Classic is sunsetting — keep it reachable for the wind-down but
  // out of search so the new product at "/" is the canonical landing.
  robots: { index: false, follow: true },
  title: "MixReflect Classic — Get Real Feedback on Your Music Before You Release",
  description:
...
const faqItems = [
  ...
  { q: "Do I need to pay to get music feedback?", a: "No. MixReflect is free to use. You earn credits by reviewing other artists' tracks, then spend those credits to get reviews on your own music. No upfront cost, no credit card required. Want credits without reviewing? Grab a 10-credit pack for $9.95, or go Pro ($24.95/month) for 30 credits every month plus priority queue placement." },
  { q: "Is it really free?", a: "Yes. You can upload tracks, earn credits by reviewing, and access full analytics — all for free, forever. Pro is for artists who want credits without the reviewing, faster turnaround with priority placement, and more tracks in review at once." },
  { q: "What does Pro get me?", a: "Pro gives you 30 fresh credits every month — no reviewing required to earn them. Priority placement means your tracks appear at the top of the reviewer queue with a Priority badge, so you get feedback faster. Up to 3 tracks in review at once, up to 10 reviews per track, and unlimited reviews per day so you can keep earning without hitting a cap. $24.95/month, cancel anytime." },
