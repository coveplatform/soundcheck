        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between h-14 gap-4">
            ...
            <nav className="flex items-center gap-1 text-sm overflow-x-auto no-scrollbar">
              ...
              <Link href="/admin/reviewers" className="px-2.5 sm:px-3 py-1.5 rounded-md text-neutral-600 hover:text-neutral-900 hover:bg-neutral-100 font-medium transition-colors whitespace-nowrap text-xs sm:text-sm">
                Reviewers
              </Link>
