    ...
    <div className="min-h-screen bg-[#faf7f2] pb-24 overflow-x-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8">
        <div className="flex items-end justify-between mb-5">
          <div>
            <p className="text-[10px] font-black uppercase tracking-[0.3em] text-black/30">Your Queue</p>
          ...
          <Link href="/tracks" className="text-[11px] font-black uppercase tracking-wider text-black/30 hover:text-black transition-colors">
            Manage →
          </Link>
        </div>
