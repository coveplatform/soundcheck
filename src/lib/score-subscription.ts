...
// Pricing lives in score-pricing.ts (client-safe, no prisma); re-exported here
// so server code keeps importing everything from one place.
export { UNLOCK_PRICE_CENTS, scoreSubPrice, type SubPlan } from "@/lib/score-pricing";
