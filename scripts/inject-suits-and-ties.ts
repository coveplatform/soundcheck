...
const TRACK_ID = "cmplhs1cv000004l4iwdhs9kn";
const ARTIST_EMAIL = "brianshankmusic@gmail.com";
const TRACK_TITLE = "Suits and Ties";
...
const REVIEWS = [
  {
    ...
    bestPart: "the overall vibe is solid and you can tell theres a real idea here. it just has a good feel to it and the track makes sense as a whole, like it knows what it wants to be",
    biggestWeaknessSpecific: "main thing for me is how the elements come in and out. it feels a bit loose in places, like somthing will appear and then leave before it really had a chance to land properly. or a part drops in a bit abruptly without much build up to it. the structure could just be a little tighter in that sense. when you get the intros and outros of your sections feeling more deliberate the whole thing will click much better. good track overall though",
  },
];
