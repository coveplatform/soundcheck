...
const TRACK_ID = "cmplwqy8z000304l77djx6367";
const ARTIST_EMAIL = "allen13256@gmail.com";
const TRACK_TITLE = "danzo - race against time (prod. 2ni)";
...
const REVIEWS = [
  {
    ...
    bestPart: "the mids on this are really punchy and present, gives it this gritty feel that suits the track perfectly. genuinely enjoyed this one, its got a real energy to it",
    biggestWeaknessSpecific: "the highs could open up just a bit more i think. they feel slightly held back in places and if you let them breathe a little the whole thing would feel more open and airy. not a big deal at all though because honestly there is loads of potential here and you can clearly hear you know what you're doing. keep going with this direction for sure, this is good stuff",
  },
];
